    ...
    <Component
      className={clsx(
        "flex items-center gap-2 justify-center rounded  font-bold transition-colors ",
        {
          ...
          "bg-default-700 hover:bg-default-hover": color === 'default'  && variant === 'solid',
          ...
          "bg-transparent ring-1 ring-default-700 hover:ring-default-hover text-default-700": color === 'default'  && variant === 'border',
